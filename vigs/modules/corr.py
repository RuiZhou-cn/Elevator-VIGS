...
class CorrSampler(torch.autograd.Function):
    ...
    def forward(ctx, volume, coords, radius):
        ...
        ctx.radius = radius
        corr, = vigs_backends.corr_index_forward(volume, coords, radius)
        return corr
    ...
    def backward(ctx, grad_output):
        ...
        grad_volume, = vigs_backends.corr_index_backward(volume, coords, grad_output, ctx.radius)
...
class CorrLayer(torch.autograd.Function):
    ...
    def forward(ctx, fmap1, fmap2, coords, r):
        ...
        corr, = vigs_backends.altcorr_forward(fmap1, fmap2, coords, ctx.r)
        return corr
    ...
    def backward(ctx, grad_corr):
        ...
        fmap1_grad, fmap2_grad, coords_grad = \
            vigs_backends.altcorr_backward(fmap1, fmap2, coords, grad_corr, ctx.r)
